...
#include <unistd.h>      //for fork(), exec() system calls
#include <stdlib.h>      //for malloc(), free(), exit() functions
#include <stdio.h>      
#include <sys/types.h>    //process pid(), wait()
#include <sys/stat.h>     // opening and creating files
#include <fcntl.h>        //opening and creating files
#include <errno.h>        // intrupted error returned by system call
#include <sys/wait.h>     // for consol waiting
